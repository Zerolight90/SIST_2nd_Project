...
<script>
  (function($){
      ...
      try {
        ...
        if (audienceCanvas) {
          ...
          if (audienceChartInstance) {
            audienceChartInstance.destroy();
          }

          let audienceData = [0, 23632, 23500];
          let audienceLabels = ['08.11', '08.16', '08.17'];

          audienceChartInstance = new Chart(audienceCtx, {
            type: 'line',
            data: {
    ...
    window.onYouTubeIframeAPIReady = function() {
      let trailerUrl = "${movie.trailer != null ? movie.trailer : ''}";
        ...
        $reviewForm.on('submit', function(e) {
          ...
          $.ajax({
            ...
            `);
              ...
              $newReview[0].scrollIntoView({ behavior: "smooth" });
