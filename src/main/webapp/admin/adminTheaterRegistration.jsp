        ...
        <tr>
          ...
          <td>
            <ul class="facilities-list">
              <li>
                <input type="checkbox" id="basicScreen" name="tFacilities" value="일반상영관"/>
                <label for="basicScreen">일반상영관</label>
              </li>
              <li>
                <input type="checkbox" id="disabledSeat" name="tFacilities" value="장애인석"/>
                <label for="disabledSeat">장애인석</label>
              </li>
              <li>
                <input type="checkbox" id="mx4d" name="tFacilities" value="MX4D"/>
                <label for="mx4d">MX4D</label>
              </li>
              <li>
                <input type="checkbox" id="sweetRoom" name="tFacilities" value="스위트룸"/>
                <label for="sweetRoom">스위트룸</label>
              </li>
              <li>
                <input type="checkbox" id="comfort" name="tFacilities" value="컴포트"/>
                <label for="comfort">컴포트</label>
              </li>
              <li>
                <input type="checkbox" id="special" name="tFacilities" value="스페셜"/>
